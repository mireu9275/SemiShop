package kr.eme.semiShop.coroutine

import kr.eme.semiShop.SemiShop
import kr.eme.semiShop.coroutine.SynchronizationContext.ASYNC
import kr.eme.semiShop.coroutine.SynchronizationContext.SYNC
...
fun sync(block: suspend BukkitSchedulerController.() -> Unit): CoroutineTask = getNewTask(SemiShop.instance,SYNC,block)
fun async(block: suspend BukkitSchedulerController.() -> Unit): CoroutineTask = getNewTask(SemiShop.instance,ASYNC,block)
